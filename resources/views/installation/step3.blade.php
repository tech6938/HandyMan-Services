...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Demandium Software Installation" aria-valuenow="60"
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="database-name" class="form-control" name="DB_DATABASE"
                                        required placeholder="{{ translate('Ex: project-name-db') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="database-username" class="form-control" name="DB_USERNAME"
                                        required placeholder="{{ translate('Ex: root') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
