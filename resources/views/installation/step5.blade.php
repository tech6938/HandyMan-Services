...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Demandium Software Installation" aria-valuenow="90"
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="web_name" required
                                        placeholder="{{ translate('Ex: Demandium') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="confirm-password"
                                        class="d-flex align-items-center gap-2 mb-2">{{ translate('Confirm Password') }}</label>
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" autocomplete="new-password" id="confirm_password"
                                            name="confirm_password" class="form-control"
                                            placeholder="{{ translate('Ex: 8+ character') }}" required>
                                        <div class="togglePassword">
                                            <img src="{{ asset('assets/installation') }}/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">
                                            <img src="{{ asset('assets/installation') }}/assets/img/svg-icons/eye-off.svg"
