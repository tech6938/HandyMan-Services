...
<body style="background-color: #fff;">
    <div class="box">
        <div class="top-wrap-box">
            ...
            <h3 style="margin-top: 20px">{{ translate('Welcome to') }}
            ...
            <p>{{ translate('Remember to reset your password when you log in for the first time to ensure the security of your account.') }}
            </p>
            ...
            @if ($webUrl && $webUrl->is_active)
                <p>{{ translate('Change password:') }} <a
                        href="{{ $url }}">{{ translate('Click to change') }}</a></p>
            @endif
