                    ...
                    <div class="row mb-4 g-4">
                        <div class="col-lg-4 col-sm-12">
                            <div class="statistics-card statistics-card__total-orders">
                                ...
                                <img src="{{ asset('assets/admin-module') }}/img/icons/total-orders.png" class="absolute-img"
                                    alt="">
                            </div>
                        </div>
                ...
                <ul class="nav nav--tabs nav--tabs__style2">
                    <li class="nav-item">
                        <button class="nav-link {{ !isset($web_page) || $web_page == 'overview' ? 'active' : '' }}"
                            data-bs-toggle="tab" data-bs-target="#overview-tab-pane">{{ translate('overview') }}
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link {{ isset($web_page) && $web_page == 'bookings' ? 'active' : '' }}"
                            data-bs-toggle="tab" data-bs-target="#bookings-tab-pane">{{ translate('bookings') }}</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link {{ isset($web_page) && $web_page == 'reviews' ? 'active' : '' }}"
                            data-bs-toggle="tab" data-bs-target="#reviews-tab-pane">{{ translate('reviews') }}
                        </button>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body p-30">
                            <div class="media flex-column flex-md-row gap-3 mb-3">
                                <div class="">
                                    <img width="300" src="{{ $customer->profile_image_full_path }}"
                                ...
                                <table id="example" class="table align-middle">
                                    ...
                                    <tbody>
                                        @foreach ($reviews as $review)
                                            <tr>
                                                <td>{{ $review->customer ? $review->customer->first_name : '' }}
                                                    {{ $review->customer ? $review->customer->last_name : '' }}</td>
