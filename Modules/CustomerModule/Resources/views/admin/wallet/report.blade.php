                                ...
                                <div class="row">
                                        ...
                                        <select class="js-select customer__select" name="customer_ids[]"
                                            ...
                                            @foreach ($customers as $customer)
                                                <option value="{{ $customer['id'] }}"
                                                    {{ array_key_exists('customer_ids', $queryParams) && in_array($customer['id'], $queryParams['customer_ids']) ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-30">
                                        <select class="js-select" name="trx_type">
                                            ...
                                            <option
                                                value="all"{{ array_key_exists('trx_type', $queryParams) && $queryParams['trx_type'] == 'all' ? 'selected' : '' }}>
                                                {{ translate('All') }}</option>
                                            @foreach (WALLET_TRX_TYPE as $type)
                                                <option value="{{ $type }}"
                                                    {{ array_key_exists('trx_type', $queryParams) && $queryParams['trx_type'] == $type ? 'selected' : '' }}>
                                            ...
                                            <tbody>
                                                @forelse($filteredTransactions as $key=>$transaction)
                                                    <tr>
                                                        ...
                                                        <td>{{ date('d-M-Y h:ia', strtotime($transaction->created_at)) }}
                                                        </td>
                                                        <td>
                                                            @if (isset($transaction->to_user))
                                                                ...
                                                                <div class="d-flex fz-10">
                                                                    {{ translate($transaction->to_user_account) }}</div>
                                                            @else
                                                                <span
