                    ...
                    <div class="d-flex flex-column flex-sm-row flex-wrap gap-4 mt-4">
                        <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                            <img width="35" class="avatar"
                                src="{{ asset('assets/admin-module') }}/img/icons/total_expenses.png" alt="">
                            <div>
                                <h2 class="fz-26">{{ with_currency_symbol($total_promotional_cost['total_expense']) }}
                                </h2>
                        ...
                        <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                            <img width="35" class="avatar"
                                src="{{ asset('assets/admin-module') }}/img/icons/campaign_discount.png" alt="">
                            <div>
                        ...
                        <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                            <img width="35" class="avatar"
                                src="{{ asset('assets/admin-module') }}/img/icons/coupon_discount.png" alt="">
                            <div>
                        ...
                        <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                            <img width="35" class="avatar"
                                src="{{ asset('assets/admin-module') }}/img/icons/extra_discount.png" alt="">
                            <div>
                        ...
                        <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                            ...
                            <div>
                                <h2 class="fz-26">
                                    {{ with_currency_symbol($total_promotional_cost['referral_discount']) }}</h2>
