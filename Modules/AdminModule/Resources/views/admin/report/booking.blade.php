                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <div class="card p-30 flex-grow-1">
                                    <div class="d-flex gap-4 flex-wrap">
                                        ...
                                        <div class="text-center">
                                            <h2 class="fz-26">
                                                {{ with_currency_symbol($booking_amount['total_booking_amount']) }}</h2>
                                        ...
                                        <select class="js-select booking-status__select" name="booking_status"
                                            ...
                                            @foreach (BOOKING_STATUSES as $booking_status)
                                                <option value="{{ $booking_status['key'] }}"
                                                    {{ $booking_status['key'] === request()->input('booking_status') ? 'selected' : '' }}>
                                        ...
                                        @forelse($filtered_bookings as $key=>$booking)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <div class="fw-medium badge badge badge-danger radius-50">
                                                            {{ translate('Customer_not_available') }}</div>
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    @else
                                                        <div class="fw-medium badge badge badge-danger radius-50">
                                                            {{ translate('Provider_not_available') }}</div>
                                                    @endif
                                                </td>
