                            ...
                            <div class="d-flex flex-wrap justify-content-between gap-3 mb-4">
                                ...
                                <div class="select-wrap d-flex flex-wrap gap-10">
                                    <select class="js-select min-w180 h-30 top-customers__select">
                                        <option value="" disabled selected>{{ translate('Select_Date_Range') }}
                                        </option>
                                            ...
                                            @if ($item->service)
                                                <li>
                                                    <div
                                                        ...
                                                        <span
                                                            class="booking-count">{{ with_decimal_point(($item['total_volume'] * 100) / $total) }}%
                                                            {{ translate('search volume') }}</span>
                                                    </div>
                                                    <div class="progress">
                                        ...
                                        <td>
                                            <div class="media align-items-center gap-3">
                                                <div class="avatar avatar-lg">
                                                    <a
                                                        href="{{ route('admin.customer.detail', [$customer->id, 'web_page' => 'overview']) }}">
...
@push('script')
    ...
    <script>
        ...
        $(".top-customers__select").on('change', function() {
            if (this.value !== "") location.href = "{{ route('admin.analytics.search.customer') }}" +
                '?date_range=' + this.value + '&date_range_2=' + '{{ $queryParams['date_range_2'] ?? 'all_time' }}';
        });
