                        ...
                        <div class="card-body py-xl-5">
                            <div class="row justify-content-center align-items-center gy-5">
                                <div class="col-7 col-lg-5">
                                    ...
                                    <p>{{ translate('Suggest more services that are willing to book and help us make  more efficient platform for you') }}
                                        ...</p>
                                    ...
                                    <div class="collapse" id="serviceForm">
                                        <form action="{{ route('provider.service.make-request') }}" method="post">
                                            ...
                                            <div class="form-floating mb-30">
                                                <textarea class="form-control" placeholder="{{ translate('Provide Some Description') }}" id="floatingTextarea"
                                                    name="service_description" required>{{ old('service_description') }}</textarea>
                                                <label
                                                    for="floatingTextarea">{{ translate('Provide Some Description') }}</label>
                                            </div>
                                    ...
                                    <a href="#serviceForm" class="btn btn--primary show_form-btn"
                                        data-bs-toggle="collapse">{{ translate('Send Request') }}</a>


                                </div>
                                <div class="col-5 col-lg-5">
                                    <div class="text-center">
                                        <img width="220" src="{{ asset('assets/admin-module/img/media/serv.png') }}"
