...
class Variation extends Model
{
    ...
    protected $fillable = ['variant', 'variant_key', 'zone_id', 'price', 'service_id', 'service_img'];

    protected $appends = ['service_img_full_path'];

    public function getServiceImgFullPathAttribute(): ?string
    {
        if (empty($this->service_img)) {
            return null;
        }

        return asset('storage/service/' . $this->service_img);
    }
