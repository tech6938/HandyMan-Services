                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    ...
                                    <div class="text-center">
                                        <h2 class="fz-26">{{ with_currency_symbol(array_sum($chartData['net_profit'])) }}
                                        </h2>
                                ...
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    ...
                                    <div class="text-center">
                                        <h2 class="fz-26">
                                            {{ with_currency_symbol(array_sum($chartData['total_earning'])) }}</h2>
                                ...
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    ...
                                    <div class="text-center">
                                        <h2 class="fz-26">
                                            {{ with_currency_symbol(array_sum($chartData['total_expense'])) }}</h2>
                                    ...
                                    <tbody>
                                        @foreach ($bookings as $key => $booking)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ with_currency_symbol($booking->booking_details_amounts->discount_by_provider ?? 0) }}
                                                </td>
                                                <td>{{ with_currency_symbol($booking['total_coupon_discount_amount']) }}
                                                </td>
                                                <td>{{ with_currency_symbol($booking->booking_details_amounts->coupon_discount_by_provider ?? 0) }}
                                                </td>
                                                <td>{{ with_currency_symbol($booking['total_campaign_discount_amount']) }}
                                                </td>
                                                <td>{{ with_currency_symbol($booking->booking_details_amounts->campaign_discount_by_provider ?? 0) }}
                                                </td>

                                                <td>{{ with_currency_symbol($booking['total_booking_amount']) }}</td>
                                                <td>{{ with_currency_symbol($booking['total_tax_amount']) }}</td>
                                                <td>{{ with_currency_symbol($booking->booking_details_amounts->admin_commission ?? 0) }}
                                                </td>
