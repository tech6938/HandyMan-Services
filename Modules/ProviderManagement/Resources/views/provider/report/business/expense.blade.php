                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    ...
                                    <div class="text-center">
                                        <h2 class="fz-26">
                                            {{ with_currency_symbol($totalPromotionalCost['total_expense']) }}</h2>
                                ...
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    ...
                                    <div class="text-center">
                                        <h2 class="fz-26">{{ with_currency_symbol($totalPromotionalCost['discount']) }}
                                        </h2>
                                ...
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    <img width="35" class="avatar"
                                        ...
                                        alt="">
                                    <div class="text-center">
                                        <h2 class="fz-26">{{ with_currency_symbol($totalPromotionalCost['campaign']) }}
                                        </h2>
                                ...
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    <img width="35" class="avatar"
                                        ...
                                        alt="">
                                    <div class="text-center">
                                        <h2 class="fz-26">{{ with_currency_symbol($totalPromotionalCost['coupon']) }}
                                        </h2>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('provider.report.business.expense.download') . '?' . http_build_query($queryParams) }}">{{ translate('Excel') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        @forelse($filteredBookingAmounts as $key=>$amount)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ with_currency_symbol($amount['campaign_discount_by_provider']) }}
                                                </td>
                                                <td class="text--end">{{ with_currency_symbol($total_expense) }}</td>
                                            </tr>
                                        @empty
                                            <tr class="text-center">
                                                <td colspan="6">{{ translate('Data_not_available') }}</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
