                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    ...
                                    <div class="text-center">
                                        <h2 class="fz-26">
                                            {{ with_currency_symbol(array_sum($chartData['earnings']) - array_sum($chartData['expenses'])) }}
                                        </h2>
                                ...
                                <div class="card p-30 flex-grow-1">
                                    <div class="d-flex gap-4 flex-wrap">
                                        <img width="35" class="avatar"
                                            src="{{ asset('assets/admin-module') }}/img/icons/total_expense.png"
                                            alt="">
                                        <div class="text-center">
                                            <h2 class="fz-26">
                                                {{ with_currency_symbol(array_sum($chartData['expenses'])) }}</h2>
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between gap-2 mt-30">
                                        <div class="d-flex flex-column align-items-center gap-2 fz-12">
                                            <span
                                                class="c1 fw-semibold">{{ with_currency_symbol($totalPromotionalCost['campaign']) }}</span>
                                            <span class="opacity-50">{{ translate('Campaign') }}</span>
                                        </div>
                                        <div class="d-flex flex-column align-items-center gap-2 fz-12">
                                            <span
                                                class="c1 fw-semibold">{{ with_currency_symbol($totalPromotionalCost['discount']) }}</span>
                                            <span class="opacity-50">{{ translate('Normal_Discount') }}</span>
                                        </div>
                                        <div class="d-flex flex-column align-items-center gap-2 fz-12">
                                            <span
                                                class="c1 fw-semibold">{{ with_currency_symbol($totalPromotionalCost['coupon']) }}</span>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('provider.report.business.overview.download') . '?' . http_build_query($queryParams) }}">{{ translate('Excel') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        @forelse($amounts as $key=>$item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text--end"><span
                                                        class="text-success">{{ with_currency_symbol($net_profit_rate) }}
                                                        %</span></td>
                                            </tr>
                                        @empty
                                            <tr>
