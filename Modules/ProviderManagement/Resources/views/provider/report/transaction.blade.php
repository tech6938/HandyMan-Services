                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-3 mb-4">
                                <div class="statistics-card statistics-card__total-orders border flex-grow-1">
                                    <h2>{{ with_currency_symbol($account_info->received_balance + $account_info->total_withdrawn) }}
                                    </h2>
                                    ...
                                    <div class="absolute-img" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('assets/provider-module') }}/img/icons/info.svg" class="svg"
                                            alt="">
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle">
                                            ...
                                            <tbody>
                                                        ...
                                                        <td>
                                                            @if (isset($transaction->to_user))
                                                                ...
                                                                <div class="d-flex fz-10">
                                                                    {{ translate($transaction->trx_type) }}</div>
                                                            @else
                                                ...
                                                @empty
                                                    <tr>
                                                        <td class="text-$filtered_transactionscenter" colspan="7">
