...
<div class="modal-body pb-4 px-lg-4">
    <div class="d-flex flex-column align-items-center">
        <img width="75" class="mb-3" src="{{ asset('assets/provider-module') }}/img/icons/notification.png"
            alt="">
        ...
        <div class="mb-4 text-center d-flex flex-column align-items-center">
            <div class="avatar avatar-lg mb-2">
                <img class="rounded" src="{{ $post?->customer?->profile_image_full_path }}"
                    alt="{{ translate('image') }}">
            </div>
        ...
        <div class="media gap-2 mb-4">
            <img width="30" src="{{ $post?->sub_category?->image_full_path }}" alt="{{ translate('image') }}">
