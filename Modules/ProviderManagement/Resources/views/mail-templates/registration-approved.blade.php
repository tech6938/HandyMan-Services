    ...
    <div class="box">
        <div class="top-wrap-box">
            ...
            @if ($emailVerification && !$provider->owner->is_email_verified)
                ...
                <button class="btn"><a
                        href="{{ route('provider.auth.verification.index') }}">{{ translate('Verify') }}</a></button>
            @else
                <p>{{ translate('Your registration request has been approved by admin. Now you can login as a provider and view all the options') }}.
                </p>
            @endif
