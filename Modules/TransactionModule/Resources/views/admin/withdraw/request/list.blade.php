                                    ...
                                    <div class="select-table-wrap">
                                        <div
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-3">
                                                <select class="js-select theme-input-style w-100" id="multi-status__select"
                                                    required>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-capitalize">
                                                                @if ($withdrawRequest?->user?->provider)
                                                                    <a
                                                                        href="{{ route('admin.provider.details', [$withdrawRequest->user->provider->id, 'web_page' => 'overview']) }}">
                                                            ...
                                                            <td>
                                                                <div class="max-w320 min-w120 text-two-line"
                                                                    ...
                                                                    @if ($withdrawRequest->note) data-bs-title="{{ $withdrawRequest->note }}" @endif>
                                                            ...
                                                            <td>
                                                                <div class="max-w320 min-w120 text-two-line"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    @if ($withdrawRequest->admin_note) data-bs-title="{{ $withdrawRequest->admin_note }}" @endif>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    ...
                                                                    <div>
                                                                        {{ date('H:iA', strtotime($withdrawRequest->created_at)) }}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                    ...
                                                                    @can('withdraw_manage_status')
                                                                        @if ($withdrawRequest->request_status == 'pending')
                                                                            <button type="button"
                                                                                ...
                                                                                style="--size: 30px" data-bs-toggle="modal"
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body">
                                                                                            <form
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        @if ($withdrawRequest->provider)
                                                                                                            <h5
                                                                                                                class="c1 mb-2">
                                                                                                                {{ $withdrawRequest->provider->company_name }}
                                                                                                            </h5>
                                                                                                            <ul
                                                                                                                class="list-info">
                                                                                                                <li>
                                                                                                                    ...
                                                                                                                    <a
                                                                                                                        href="tel:{{ $withdrawRequest->provider->company_phone }}">{{ $withdrawRequest->provider->company_phone }}</a>
                                                                                                                </li>
                                                                                                                <li>
                                                                                                                    <span
                                                                                                                        class="material-icons">map</span>
                                                                                                                    <p>{{ $withdrawRequest->provider->company_address }}
                                                                                                                    </p>
                                                                                                                </li>
                                                                                                            </ul>
                                                                                                        @endif
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="c1-light-bg radius-10 py-3 px-4 flex-grow-1">
                                                                                                        <h4 class="mb-2">
                                                                                                            {{ translate('Withdraw_Method_Information') }}
                                                                                                        </h4>
                                                                                                        <ul
                                                                                                            class="list-info gap-1">
                                                                                                            @forelse($withdrawRequest->withdrawal_method_fields as $key=>$value)
                                                                                                                <li>
                                                                                                                    <span
                                                                                                                        class="font-weight-bold"><b>{{ translate($key) }}</b>:
                                                                                                                    </span>
                                                                                                                    <span>{{ $value }}</span>
                                                                                                                </li>
                                                                                                            @empty
                                                                                                ...
                                                                                                <textarea class="form-control h-140 resize-none" placeholder="{{ translate('Note') }}" name="note"></textarea>
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <form
                                                                                                ...
                                                                                                <div class="text-center">
                                                                                                    ...
                                                                                                    <h3 class="mb-3">
                                                                                                        {{ translate('Settled_this_request') }}
                                                                                                        ?</h3>
                                                                                                </div>
                ...
                <div class="modal-body py-5">
                    ...
                    <div class="text-center mw-340 mx-auto">
                        ...
                        <ul class="text-start text-muted d-flex flex-column gap-2">
                            ...
                            <li>{{ translate('Update  the request status column with the request status (approved, denied, settled)') }}
                            </li>
                        </ul>
                        <p class="title-color fz-12 mb-5">
                            {{ translate('NB: Do not modify the initial row of the excel file') }}</p>
                        <form action="{{ route('admin.withdraw.request.import') }}" id="uploadProgressForm"
                            ...
                            <div class="mt-5 card p-3">
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    <div class="">
                                        <img width="24" src="{{ asset('assets/admin-module') }}/img/media/excel.png"
                                            alt="">
                                    </div>
                            ...
                            <button type="submit"
                                class="btn btn--primary mt-4 w-100">{{ translate('Submit') }}</button>
                        </form>
                    </div>
                </div>
            </div>
