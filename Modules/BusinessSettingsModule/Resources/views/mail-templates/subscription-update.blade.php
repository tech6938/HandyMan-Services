...
<head>
    ...
    <title>{{ translate('Subscription Update') }}</title>
...
<body style="background-color: #fff;">
    <div class="box">
        <div class="top-wrap-box">
            <img src="{{ asset('assets/admin-module/img/email/subscription-update.png') }}"
                alt="{{ translate('Logo') }}" width="140" />

            <h3 style="margin-top: 20px">{{ translate('Subscription Package Has Been Updated') }} !</h3>
            <h5>{{ translate('Hi') }} {{ $provider?->company_name }},</h5>
            <p>{{ translate('Your Subscription Plan Has Been Updated.') }}
                .</p><br><br>
            <p>{{ translate('Click here to visit your provider panel and see the subscription package update.') }}</p>
