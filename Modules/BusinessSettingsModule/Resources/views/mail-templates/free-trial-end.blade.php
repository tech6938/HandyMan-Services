...
<body style="background-color: #fff;">
    <div class="box">
        <div class="top-wrap-box">
            ...
            <p>{{ translate('Your Free Trial has ended. To continue using') }}
                {{ business_config('business_name', 'business_information')->live_values }}
                {{ translate(', please choose a paid business plan. If you have questions or need assistance, contact our support team. We appreciate your cooperation.') }}
            </p>
        </div>
