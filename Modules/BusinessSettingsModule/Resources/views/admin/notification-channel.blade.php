            ...
            @can('configuration_manage_status')
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-3">
                    <ul class="nav nav--tabs nav--tabs__style2">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->get('notification_type') == 'user' ? 'active' : '' }}"
                                href="{{ url()->current() }}?notification_type=user">
                                Customer
                            </a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        <tr>
                                            ...
                                            @can('notification_channel_manage_status')
                                                <td>
                                                    ...
                                                    @else
                                                        <label class="switcher">
                                                            <input class="switcher_input" name="notification" type="checkbox"
                                                                data-id="{{ $notification->id }}" data-type="notification"
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <label class="switcher">
                                                            <input class="switcher_input" name="email" type="checkbox"
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <label class="switcher">
                                                            <input class="switcher_input" name="sms" type="checkbox"
