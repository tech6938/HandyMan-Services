                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h3 class="text-center mb-4">
                                                    {{ translate('Upload_Picture_Before_Completing_The') }}
                                                    <br class="d-none d-sm-block"> {{ translate('Service') }} ?
                                                </h3>
                                            ...
                                            <div class="modal-body">
                                                <form class="otp-form mx-auto" id="otp_form" name="otp_form"
                                                    ...
                                                    <h4 class="text-center mb-5">
                                                        {{ translate('Please Collect OTP from your customer
                                                                                                                &
                                                                                                                Insert Here') }}
                                                    </h4>
                                                    <div
                                                    ...
                                                    <div class="d-flex justify-content-between gap-2 mb-5 mt-30">
                                                        <span class="text-muted">{{ translate('Did not get any OTP') }}
                                                            ?</span>
                                                        <span
    ...
    <script>
        ...
        function update_booking_details(route, message, componentId, updatedValue, type = 'get') {
            Swal.fire({
                ...
                if (result.value) {
                    let evidence_status =
                        {{ business_config('service_complete_photo_evidence', 'booking_setup')->live_values == 1 ? 'true' : 'false' }};
                    let booking_otp_status =
                        {{ business_config('booking_otp', 'booking_setup')->live_values == 1 ? 'true' : 'false' }};
                                    ...
                                    success: function(response) {
                                        ...
                                        if (booking_otp_status) {
                                            ...
                                            .serialize(); // Serialize the form data
                                                proceed_with_main_ajax_request(route,
                                                    componentId, updatedValue,
                                                    'PUT', formData);
                                            });
                                        } else {
                                            proceed_with_main_ajax_request(route, componentId,
                                                updatedValue, 'PUT');
                                        }
                                    },
