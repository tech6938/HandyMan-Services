                ...
                <div>
                    <div class="d-flex align-items-center gap-2 flex-wrap mb-2">
                        <h3 class="c1 d-flex align-items-center gap-1">
                            ...
                            <img width="34" height="34" src="{{ asset('assets/admin-module/img/icons/repeat.svg') }}"
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div
                                                ...
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <a href="{{ route('admin.booking.single_invoice', [$booking->nextService['id']]) }}"
                                        ...
                                        <div class="card card-border w-100">
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="d-flex gap-2 justify-content-center">
                                                        <a href="{{ route('admin.booking.single_invoice', [$data['id']]) }}"
                                                            type="button"
                                                            class="action-btn btn--light-primary text-primary fw-medium text-capitalize fz-14"
                                                            target="_blank" style="--size: 30px">
                                                            <span class="material-icons">description</span>
                                                        </a>
                                                        <a href="{{ route('admin.booking.repeat_single_details', [$data['id'], 'web_page' => 'details']) }}"
                                                            type="button"
                                                            class="action-btn btn--light-primary fw-medium text-capitalize fz-14"
                                                            style="--size: 30px">
                                                            <span class="material-icons">visibility</span>
                            ...
                            @if (!empty($booking['upComing']))
                                ...
                                @foreach ($booking['upComing'] as $upComing)
                                        ...
                                        <div class="__bg-FAFAFA card card-border w-100 shadow-none">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center gap-3">
                                                    ...
                                                    <div class="dropstart">
                                                        <a href="javascript:" class="title-color"
                                    ...
                                    <div class="modal fade" id="reschedule-{{ $upComing['id'] }}"
                                        data-bs-backdrop="static" tabindex="-1" aria-labelledby="" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form
                                                    action="{{ route('admin.booking.up_coming_booking_schedule_update', [$upComing['id']]) }}"
                                                    method="post">
                                                    @csrf
