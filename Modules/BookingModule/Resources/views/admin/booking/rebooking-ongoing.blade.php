...
@section('content')
            ...
            <div class="pb-3 d-flex justify-content-between align-items-center gap-3 flex-wrap">
                <div>
                    <h5 class="mb-2">{{ translate('Booking') }} # {{ $booking->booking->readable_id }}
                        <span class="fw-normal title-color">({{ translate('Total_Booking') }} -
                            {{ count($booking->booking->repeat) }})</span>
                    </h5>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-2">
                                            ...
                                            <span
                                                class="text-info fw-semibold">{{ ucwords(str_replace(['_', '-'], ' ', $booking->payment_method)) }}
                                            </span>
                                        </p>
                                        <p class="mb-2">
                                    ...
                                    <div class="text-start text-sm-end">
                                        ...
                                        @if ($booking?->scheduleHistories->count() > 1)
                                            <h5 class="d-flex gap-1 flex-wrap align-items-center">
                                                ...
                                                <div>
                                                    <div>
                                                        {{ date('d-M-Y h:ia', strtotime($booking->scheduleHistories->first()->schedule)) }}
                                                    </div>
                                                </div>
                                            </h5>
                                                    ...
                                                    @if (!$booking?->is_guest)
                                                        <li>
                                                            <div
                                                                ...
                                                                <form action="{{ route('admin.chat.create-channel') }}"
                                                                    method="post"
                                                                    id="chatForm-{{ $booking->booking_id }}">
                                                                    @csrf
                                                                    <input type="hidden" name="customer_id"
                                                                        value="{{ $booking?->booking?->customer?->id }}">
                                                                    <input type="hidden" name="type" value="booking">
                                    ...
                                    @else
                                        ...
                                        <div class="text-center pb-4">
                                            <button class="btn btn--primary" data-bs-target="#providerModal"
                                                ...
                                                @if ($booking['booking_status'] == 'canceled') disabled @endif>{{ translate('assign provider') }}</button>
                                        </div>
                                    @endif
                                </div>
                                    ...
                                    @else
                                        ...
                                        <div class="text-center pb-4">
                                            <button class="btn btn--primary" data-bs-target="#servicemanModal"
                                                data-bs-toggle="modal" @if ($booking['booking_status'] == 'completed' || $booking['booking_status'] == 'canceled' || !isset($booking->provider)) disabled @endif>
    ...
    <div class="modal fade" id="serviceAddressModal--{{ $booking['id'] }}" tabindex="-1"
        aria-labelledby="serviceAddressModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body pt-0 m-4">
                        <div class="d-flex flex-column gap-2 align-items-center">
                            <img width="75" class="mb-2"
                                src="{{ asset('assets/provider-module') }}/img/media/address.jpg" alt="">
                                    ...
                                    <div class="mb-30">
                                        <div class="form-floating">
                                            <input type="text"
                                                ...
                                                name="contact_person_number" id="contact_person_number"
                                            ...
                                            <div class="">
                                                <input type="text" class="country-picker-phone-number w-50"
                                                    ...
                                                    name="contact_person_number" hidden readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="mb-30">
                                        <select class="js-select theme-input-style w-100" name="address_label">
                                            ...
                                            <option value="home"
                                                {{ $customerAddress?->address_label == 'home' ? 'selected' : '' }}>
                                                {{ translate('Home') }}</option>
                                            <option value="office"
                                                {{ $customerAddress?->address_label == 'office' ? 'selected' : '' }}>
                                                {{ translate('Office') }}</option>
                                            <option value="others"
                                                {{ $customerAddress?->address_label == 'others' ? 'selected' : '' }}>
                                                {{ translate('others') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                        ...
                                        <select class="js-select select-zone theme-input-style w-100" name="zone_id">
                                            ...
                                            @foreach ($zones as $zone)
                                                <option value="{{ $zone?->id }}"
                                                    {{ $zone?->id == $customerAddress?->zone_id ? 'selected' : null }}>
                                                    {{ $zone?->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
