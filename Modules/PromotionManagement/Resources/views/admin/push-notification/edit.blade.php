                ...
                <div class="col-12">
                    ...
                    <div class="card mb-30">
                        <div class="card-body p-30">
                            <form action="{{ route('admin.push-notification.update', [$pushNotification->id]) }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        ...
                                        <div class="form-floating mb-30">
                                            <textarea class="form-control resize-none" id="floatingInput2" placeholder="{{ translate('description') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-30">
                                                    <select class="select-zone theme-input-style w-100" name="zone_ids[]"
                                                        id="zone_selector__select" multiple="multiple">
                                                        <option value="all">{{ translate('Select All') }}</option>
                                                        @foreach ($zones as $zone)
                                                            <option value="{{ $zone->id }}"
                                                                {{ in_array($zone->id, collect($pushNotification['zone_ids'])->pluck('id')->toArray()) ? 'selected' : '' }}>
                                                                {{ $zone->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-30">
                                                    <select class="select-user theme-input-style w-100" name="to_users[]"
                                                        id="user_selector__select" multiple="multiple">
                                                        <option value="all">{{ translate('all') }}</option>
                                                        <option value="customer"
                                                            {{ in_array('customer', $pushNotification->to_users) ? 'selected' : '' }}>
                                                            {{ translate('customer') }}
                                                        </option>
                                                        <option value="provider-admin"
                                                            {{ in_array('provider-admin', $pushNotification->to_users) ? 'selected' : '' }}>
                                                            {{ translate('provider') }}
                                                        </option>
                                                        <option value="provider-serviceman"
                                                            {{ in_array('provider-serviceman', $pushNotification->to_users) ? 'selected' : '' }}>
                                        ...
                                        <div class="d-flex flex-column align-items-center gap-3">
                                            ...
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img upload-file__img_banner">
                                                    <img src="{{ $pushNotification->cover_image_full_path }}">
                                                </div>
