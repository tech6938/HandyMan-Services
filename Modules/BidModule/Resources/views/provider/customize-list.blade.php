                                ...
                                <table class="table align-middle  multi-select-table multi-select-table-provider">
                                    ...
                                    <tbody>
                                        @forelse($posts as $key=>$post)
                                            <tr>
                                                ...
                                                @if ($type != 'new_booking_request')
                                                    @if ($post->booking)
                                                        <td>
                                                            <a
                                                                href="{{ route('provider.booking.details', [$post?->booking->id, 'web_page' => 'details']) }}">{{ $post?->booking->readable_id }}</a>
                                                        </td>
                                                    @else
                                                        <td><small
                                                                                ...
                                                                                <div class="media-body">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <h5 class="text-primary">
                                                                                            {{ with_currency_symbol($bid->offered_price) }}
                                                                                        </h5>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <td>
                                                    <div class="table-actions d-flex justify-content-center">
                                                        <button type="button" class="table-actions_view action-btn"
                                                            data-bs-toggle="dropdown">
                                            ...
                                            <div class="modal fade" id="offerDetailsModal--{{ $post['id'] }}"
                                                tabindex="-1" aria-labelledby="offerDetailsModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog offer-detail-modal">
                                                    <div class="modal-content">
                                                        <div class="modal-header px-sm-4">
                                                            <h4 class="modal-title text-primary"
                                                                id="offerDetailsModalLabel">
                                                                {{ translate('My Offer Details') }}</h4>
                                                        ...
                                                        <div class="modal-body pb-4 px-lg-4">
                                                            <div class="">
                                                                        ...
                                                                        <div class=" border-start ps-4">
                                                                            <div
                                                                                ...
                                                                                <h4 class="text-primary">
                                                                                    {{ $post?->bids->where('provider_id', auth()->user()->provider->id)->first()?->offered_price ?? 0 }}
                                                                                </h4>
                                                                            </div>
                                                                            <span
                                                                ...
                                                                <h3 class="text-muted mb-2">{{ translate('Description') }}
                                                                    :</h3>
                                                                <p>{{ $post?->bids?->where('provider_id', auth()->user()->provider->id)?->first()?->provider_note }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal fade" id="newBookingModal--{{ $post['id'] }}"
                                                tabindex="-1" aria-labelledby="newBookingModalLabel" aria-hidden="true">
                                                        ...
                                                        <form
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="newBookingModalLabel">
                                                                    {{ translate('New Booking Request Form') }}</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                            ...
                                            <div class="modal fade" id="ignoreRequestModal--{{ $post['id'] }}"
                                                tabindex="-1" aria-labelledby="ignoreRequestModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column gap-2 align-items-center">
                                                                ...
                                                                <h3>{{ translate('Are you sure you want to ignore this request') }}
                                                                    ?</h3>
                                                                <div class="text-muted fs-12">
                                                                    {{ translate('You will lose the customer booking request') }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                            ...
                                            <div class="modal fade" id="withdrawRequestModal--{{ $post['id'] }}"
                                                tabindex="-1" aria-labelledby="withdrawRequestModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header border-0 pb-0">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column gap-2 align-items-center">
                                                                ...
                                                                <h3>{{ translate('Are you sure you want to withdraw this offer?') }}
                                                                    ?</h3>
                                                                <div class="text-muted fs-12">
                                                                    {{ translate('You offer will be removed for the post') }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                ...
                                                @if ($bids->count() > 0)
                                                    @foreach ($bids as $bid)
                                                        <div class="modal fade"
                                                            ...
                                                            aria-labelledby="providerInfoModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg provider-info-modal">
                                                                <div class="modal-content">
                                                                    <div class="modal-header px-sm-4">
                                                                        <h4 class="modal-title text-primary"
                                                                            id="providerInfoModalLabel">
                                                                            {{ translate('Provider Information') }}</h4>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <span>{{ $bid->provider?->rating_count }}
