...
@section('content')
                                        ...
                                        <div class="media flex-wrap gap-3">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <p>{{ Str::limit($post?->service_address?->address ?? translate('not_available'), 100) }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="{{ $bid_offers_visibility_for_providers ? 'col-lg-6' : 'col-lg-12' }}">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body pb-4">
                                        ...
                                        <p>{{ $post?->bids?->where('provider_id', auth()->user()->provider->id)->first()?->provider_note ?? translate('No description available') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body pb-4">
                                                        ...
                                                        <div class="media gap-3">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span>{{ $item?->provider?->rating_count ?? 0 }}
                                                                ...
                                                                <div
                                                                    ...
                                                                    <h4 class="text-primary">
                                                                        {{ with_currency_symbol($item->offered_price ?? 0) }}
                                                                    </h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            @if (
                                                $post->bids->count() == 0 ||
                                                    ($post->bids->count() == 1 && $post->bids->contains('provider_id', auth()->user()->provider->id)))
                                                <div class="d-flex justify-content-between gap-3 mb-4">
            ...
            <div class="modal-content">
                <form action="{{ route('provider.booking.post.update_status', [$post->id]) }}" method="GET">
                    <div class="modal-header">
                        <h5 class="modal-title" id="newBookingModalLabel">{{ translate('New Booking Request Form') }}
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="card border">
                            <div class="card-body">
                                    ...
                                    <div class="media gap-2">
                                        ...
                                        <div class="media-body">
                                            <h5 class="text-primary">
                                                {{ $post?->customer?->first_name . ' ' . $post?->customer?->last_name }}</h5>
                                ...
                                @else
                                    <span class="small">{{ translate('Not Available') }}</span>
                                @endif
                        ...
                        <div class="card border mt-3">
                            <div class="card-body">
                                <div class="mb-30">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" name="offered_price"
                                            ...
                                            id="offer-price" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="form-floating">
                                    ...
                                    <label for="add-your-note" class="d-flex align-items-center gap-1">
    ...
    <div class="modal fade" id="withdrawRequestModal--{{ $post['id'] }}" tabindex="-1"
        aria-labelledby="withdrawRequestModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column gap-2 align-items-center">
                        <img width="75" class="mb-2"
                            src="{{ asset('assets/provider-module') }}/img/media/withdraw.png" alt="">
                        <h3>{{ translate('Are you sure you want to withdraw this offer?') }}
                            ?</h3>
                        <div class="text-muted fs-12">{{ translate('You offer will be removed for the post') }}</div>
                    </div>
                </div>
                <div class="modal-footer d-flex justify-content-center gap-3 border-0 pt-0 pb-4">
                    ...
                    <a href="{{ route('provider.booking.post.withdraw', [$post->id]) }}" type="button"
                                ...
                                <div class="media gap-3">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap align-items-center fs-12 mt-1">
                                            <span class="text-danger">{{ translate('price offered') }}</span>
                                            <h4 class="text-primary">{{ with_currency_symbol($item->offered_price ?? 0) }}
                                            </h4>
                                        </div>
