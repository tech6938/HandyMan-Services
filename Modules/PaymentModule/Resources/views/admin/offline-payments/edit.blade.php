                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name="method_name"
                                                    id="method_name" placeholder="Select method name"
                                                    ...
                                                    <div class="card card-body mb-30 field-row-payment"
                                                        ...
                                                        <div class="row gy-4 align-items-center">
                                                            <div class="col-md-4">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control"
                                                                        name="title[]" placeholder="Select field name"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control"
                                                                        name="data[]" placeholder="Select data"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="d-flex justify-content-end">
                                                                    <span
                                                                        class="text-danger cursor-pointer remove-field-payment-btn"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-6 col-12">
                                            <div class="form-floating">
                                                <textarea class="form-control" name="payment_note" id="payment_note" placeholder="Select Payment Note" value=""
                                                    disabled></textarea>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center flex-column gap-3 text-center">
                        ...
                        <img width="100" src="{{ asset('assets/admin-module/img/offline_payment.png') }}"
                            alt="">
...
@push('script')
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            const numberOfFieldRowsCustomer = parentContainerCustomer.querySelectorAll('.field-row-customer')
            .length;
